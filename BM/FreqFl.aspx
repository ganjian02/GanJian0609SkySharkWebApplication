    ...
    <form id="form1" runat="server" >
        ...
        <div class="tabContents">
            <table>
                ...
                <tr>
                    <td>Total number for times Follown<asp:DropDownList ID="DropDownList1" runat="server">
                ...
                <tr>
                    <td>Customers who have paid more than a specified fare<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox></td>
                    <td>Applicable discount percentage<asp:DropDownList ID="DropDownList3" runat="server">
                        <asp:ListItem>5</asp:ListItem>
                            <asp:ListItem>10</asp:ListItem>
                            <asp:ListItem>15</asp:ListItem>
                            <asp:ListItem>20</asp:ListItem>
                ...
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="GridView1" runat="server" Width="400"></asp:GridView>
                    </td>
                </tr>
                </table>
            </div>
